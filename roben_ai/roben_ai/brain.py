import math                                                           # for trigonometry, hypot
import time                                                           # for sleep delays

import rclpy                                                          # ROS 2 Python client library :contentReference[oaicite:0]{index=0}
from rclpy.node import Node                                           # base class for ROS 2 nodes :contentReference[oaicite:1]{index=1}

from geometry_msgs.msg import PoseStamped, PoseWithCovarianceStamped   # for /initialpose and /goal_pose topics :contentReference[oaicite:2]{index=2}
