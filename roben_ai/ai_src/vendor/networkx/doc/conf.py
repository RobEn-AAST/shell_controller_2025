...
from ai_src.vendor.networkx import networkx
...
doctest_global_setup = "from ai_src.vendor.networkx import networkx as nx"
...
plot_pre_code = """
import ai_src.vendor.networkx.networkx as nx
import numpy as np
np.random.seed(42)
"""
